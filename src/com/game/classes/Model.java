...
public class Model {
    public static Instance<Snake, SnakeView, SnakeController, SnakeRunnable> createSnake(Point head, int length, Direction direction)
    ...
    public static Instance<Snake, SnakeView, SnakeController, SnakeRunnable> createSnake(Point head, int length)
            throws NoSuchMethodException {
        return createSnake(head, length, Direction.Left);
    }

    public static Instance<FoodManager, FoodManagerView, IController, FoodManagerRunnable> createFoodManager(int limit){
    ...
    public static Instance<Level, LevelView, IController, IRunnable> createLevel(Level level){
        LevelView levelView = new LevelView(level);
        return new Instance<>(level, levelView, null, null);
    }

    public static Instance<Level, LevelView, IController, IRunnable> createLevel(int width, int height) throws LevelBadSizeException {
